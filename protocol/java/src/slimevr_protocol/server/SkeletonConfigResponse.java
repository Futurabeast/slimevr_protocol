...
public final class SkeletonConfigResponse extends Table {
  ...
  public slimevr_protocol.server.SkeletonPart skeletonParts(int j) { return skeletonParts(new slimevr_protocol.server.SkeletonPart(), j); }
  public slimevr_protocol.server.SkeletonPart skeletonParts(slimevr_protocol.server.SkeletonPart obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int skeletonPartsLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public slimevr_protocol.server.SkeletonPart.Vector skeletonPartsVector() { return skeletonPartsVector(new slimevr_protocol.server.SkeletonPart.Vector()); }
  public slimevr_protocol.server.SkeletonPart.Vector skeletonPartsVector(slimevr_protocol.server.SkeletonPart.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
